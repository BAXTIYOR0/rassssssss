      ...
      e = {
        ...
        commonResult: function (e, s, r) {
          ...
          if (0 == +n ? o.fadeIn() : o.fadeOut(), r) t("." + l.attr("class")).css("display", "block"), setTimeout(() => {
            ...
            let rassrochkaModalina = document.querySelector('#rassrochkaModalina');
            rassrochkaModalina.innerHTML = i.toString().replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1 ") + " " + "so'm"


            let lzsiz = $MontheveryPrice = localStorage.getItem('MontheveryPrice').split(',');
            $MontheveryPrice.toString();
             console.log(lziz);
    
            let priceMonth = document.getElementById('priceMonth');
    
            let PriceMonthPriceFirst = document.getElementById('PriceMonthPrice').innerHTML = $MontheveryPrice[0];
            let PriceMonthPrice = PriceMonthPriceFirst;
            let monthClickKun = document.getElementById('PriceMonthPrice');
            let priceMothEvery = $MontheveryPrice[1];
            let hpacer = document.getElementById('hammasibomabdi')
            hpacer.innerHTML = $MontheveryPrice[1];
            ...
            let arrString = priceMothEvery.split(' ');
            arrString.forEach((item, i) => {
                if (!isNaN(item)) {
                    numsKreditFirst += item
                }
            })
    
            let numsKreditSecond = '';
    
    
            let arrStringSecond = PriceMonthPrice.split(' ');
            arrStringSecond.forEach((item, i) => {
                if (!isNaN(item)) {
                    numsKreditSecond += item
                }
            })
    
            let oybilanBoluvchi = numsKreditFirst / numsKreditSecond;
            let rasskredoMonth = priceMonth.innerHTML = Math.round(oybilanBoluvchi);
    
    
    
            var modal = document.getElementById("rassrochkaModal");
            var btn = document.getElementById("RassrochkaButton");
            let clickNone = document.getElementById("clickNone");
            ...
            clickNone.onclick = function () {
                modal.style.display = "none";
            }
    
            let numsKredit = '';
    
            let arrStringThird = rassrochkaModalina.split(' ');
            arrStringThird.forEach((item, i) => {
                if (!isNaN(item)) {
                    numsKredit += item
                }
            })
          ...
          if (rasskredoMonth == 6) {
              ...
              priceMothEvery = shiftThreeMonthEvery();
              priceMonth.innerHTML = '3'
              console.log(priceMonth);
              priceMonth
  
          }
          else if (rasskredoMonth == 9) {
              oylarRassrochka1.classList.remove('active');
              oylarRassrochka2.classList.remove('active');
          ...
          oylarRassrochka1.addEventListener('click', function () {
              ...
              oylikRassrochka.innerHTML = shiftThreeMonth();
              JamiHammsiRassrochka.innerHTML = shiftThreeMonthEvery();
              monthClickKun.innerHTML = shiftThreeMonth();
              priceMonth.innerHTML = '3'
              hpacer.innerHTML =  shiftThreeMonthEvery();
          ...
          oylarRassrochka2.addEventListener('click', function () {
              ...
              monthClickKun.innerHTML = shiftSexMonth();
              priceMonth.innerHTML = '6'
              hpacer.innerHTML =  shiftSexMonthEvery();
          ...
          oylarRassrochka3.addEventListener('click', function () {
              ...
              monthClickKun.innerHTML = shiftNineMonth();
              priceMonth.innerHTML = '9'
              hpacer.innerHTML =  shiftNineMonthEvery();
          ...
          oylarRassrochka5.addEventListener('click', function () {
              ...
              monthClickKun.innerHTML = shift();
              priceMonth.innerHTML = '12'
  
              hpacer.innerHTML =  shiftEvery();
          ...
          oylarRassrochka6.addEventListener('click', function () {
              ...
              monthClickKun.innerHTML = shiftfifteenMonth();
              priceMonth.innerHTML = '15'
        ...
        userForm: function () {
          ...
          let bolib = t("<a>").attr({
            class: "SmartbolvoladiBtn",
          }).text("bo'lib tolash")
          r.append(n).append(o).append(c), a.agreement.isChecked && r.append(d), k.append(u).append(m, bolib), s.append(r).append(k);

          let rassrochkaModalInBody = document.querySelector('#rassrochkaModaljon');
          bolib.click(() => {
            // console.log("adsdasdas");
            rassrochkaModalInBody.classList.add("active")
          })
          //  bolib.addEventListener("click", () => {
          //   rassrochkaModalInBody.classList.add("active")
